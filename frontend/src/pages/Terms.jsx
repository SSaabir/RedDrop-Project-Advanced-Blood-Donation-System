  ...
  return (
    <div className="py-16 bg-gray-50">
      ...
      <p className="text-gray-600 mb-4">
        ...
        property of RedDrop and is protected by intellectual property laws. Unauthorized use is
        prohibited.
      </p>

      <h2 className="text-2xl font-bold mb-4">4. Limitation of Liability</h2>
      <p className="text-gray-600 mb-4">
        RedDrop is not liable for any damages arising from the use of this website or the
        information provided. Use the website at your own risk.
      </p>

      <h2 className="text-2xl font-bold mb-4">5. Changes to Terms</h2>
      <p className="text-gray-600 mb-4">
        RedDrop reserves the right to modify these Terms & Conditions at any time. Your continued
        use of the website constitutes acceptance of the updated terms.
      </p>

      <h2 className="text-2xl font-bold mb-4">6. Governing Law</h2>
      <p className="text-gray-600 mb-4">
        These Terms & Conditions are governed by the laws of Srilanka. Any
